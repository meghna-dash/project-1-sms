    ...
    function SubscriptionHandshakeLink(subsInfoContextKey) {
        ...
        _this.onMessage = function (topic, message, selectionNames) {
            ...
            observers.forEach(function (observer) {
                try {
                    observer.next(__assign({}, parsedMessage, { data: data }));
                }
                catch (err) {
                    logger(err);
                }
    ...
    SubscriptionHandshakeLink.prototype.request = function (operation) {
        ...
        return new apollo_link_1.Observable(function (observer) {
            ...
            var newTopicsConnectionInfo = mqttConnections
                ...
                return (__assign({}, rest, { topics: topics.filter(function (t) { return newTopics.has(t); }) }));
            });
                            ...
                            if (errorCode !== 0) {
                                topics.forEach(function (t) {
                                    if (_this.topicObservers.has(t)) {
                                        _this.topicObservers.get(t).forEach(function (observer) { return observer.error(__assign({}, args, { permanent: true })); });
                                    }
                                });
                            }
