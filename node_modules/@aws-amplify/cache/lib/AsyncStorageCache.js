...
var AsyncStorageCache = /** @class */ (function (_super) {
    ...
    function AsyncStorageCache(config) {
        ...
        var cache_config = config
            ? Object.assign({}, CacheUtils_1.defaultConfig, config)
            : CacheUtils_1.defaultConfig;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (CacheUtils_1.getCurrTime() >= item.expires) {
                    ...
                    case 0:
                        ...
                        cacheItemOptions = {
                            ...
                            expires: options && options.expires !== undefined
                                ? options.expires
                                : this.config.defaultTTL + CacheUtils_1.getCurrTime(),
                        };
    ...
    AsyncStorageCache.prototype.createInstance = function (config) {
        if (config.keyPrefix === CacheUtils_1.defaultConfig.keyPrefix) {
            logger.error('invalid keyPrefix, setting keyPrefix with timeStamp');
            config.keyPrefix = CacheUtils_1.getCurrTime.toString();
        }
