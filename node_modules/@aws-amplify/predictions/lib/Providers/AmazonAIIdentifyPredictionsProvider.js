                ...
                switch (_m.label) {
                    ...
                    case 2:
                        ...
                        if (types_1.isIdentifyCelebrities(input.entities) &&
                            ...
                            this.rekognition.recognizeCelebrities(param, function (err, data) {
                                ...
                                var faces = data.CelebrityFaces.map(function (celebrity) {
                                    return {
                                        ...
                                        metadata: __assign({}, Utils_1.makeCamelCase(celebrity, ['Id', 'Name', 'Urls']), { pose: Utils_1.makeCamelCase(celebrity.Face.Pose) }),
                                    };
                                });
                                res({ entities: faces });
                            });
                            ...
                            updatedParam = __assign({}, param, { CollectionId: collectionId, MaxFaces: maxFaces });
