...
var AmazonAIPredictionsProvider = /** @class */ (function (_super) {
    ...
    function AmazonAIPredictionsProvider() {
        ...
        _this.convertProvider = new _1.AmazonAIConvertPredictionsProvider();
        _this.identifyProvider = new _1.AmazonAIIdentifyPredictionsProvider();
        _this.interpretProvider = new _1.AmazonAIInterpretPredictionsProvider();
        return _this;
    }
