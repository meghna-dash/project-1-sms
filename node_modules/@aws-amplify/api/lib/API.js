...
var APIClass = /** @class */ (function () {
    ...
    APIClass.prototype._graphql = function (_a, additionalHeaders) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _b, _c, region, appSyncGraphqlEndpoint, _d, graphql_headers, customGraphqlEndpoint, customEndpointRegion, headers, _e, _f, _g, _h, body, init, endpoint, error, response, err_1, errors;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 1:
                        ...
                        _j.label = 2;
                    case 2:
                        _c = this._options, region = _c.aws_appsync_region, appSyncGraphqlEndpoint = _c.aws_appsync_graphqlEndpoint, _d = _c.graphql_headers, graphql_headers = _d === void 0 ? function () { return ({}); } : _d, customGraphqlEndpoint = _c.graphql_endpoint, customEndpointRegion = _c.graphql_endpoint_iam_region;
                        _e = [{}];
                    ...
                    case 9:
                        headers = __assign.apply(void 0, _e.concat([(_j.sent()),
                            additionalHeaders,
                            (!customGraphqlEndpoint && (_b = {},
                                _b[USER_AGENT_HEADER] = core_1.Constants.userAgent,
                                _b))]));
                        body = {
                            ...
                            case 2:
                                ...
                                handle = observable.subscribe({
                                    ...
                                    error: function (data) {
                                        ...
                                        if (!error.errors) {
                                            error.errors = [
                                                __assign({}, new graphql_1.GraphQLError('Network Error')),
                                            ];
                                        }
